...
[dka-hero.me] 만화 옆에 한국어 번역을 나란히 보여주는 비공식 웹페이지입니다. https://aquaclara.github.io/hrmy-translate/

주소창에 `dka-hero.me`를 입력하면 만화 사이트가 그 안에 첫 화면부터 열립니다. 사이트에서 만화를 고른 다음 옆의 번역 창에서도 같은 화를 고르면 번역이 만화 옆에 나옵니다. 설치가 필요 없고 휴대폰에서도 됩니다.
